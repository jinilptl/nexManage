...
const HomePage = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(loginUserService(email, password, navigate, rememberMe));
    setEmail("");
    setPassword("");
  };
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-linear-to-br from-blue-600 to-purple-600 p-12 flex-col justify-between text-white">
        <div>
          ...
          <p className="text-blue-100 text-lg">
            ...
            time with our comprehensive project management platform.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-blue-100 text-sm">
                Track team performance and project metrics with detailed
                insights
              </p>
            </div>
          </div>
