        ...
        <div className="min-h-screen bg-linear-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-6">
            <div className="w-full max-w-md bg-white shadow-xl rounded-xl p-6 space-y-6">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                placeholder="••••••••"
                                className={`w-full border rounded-lg p-3 text-sm pr-10 transition-colors ${passwordTooShort
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                placeholder="••••••••"
                                className={`w-full border rounded-lg p-3 text-sm pr-10 transition-colors ${passwordMismatch
                                        ? "border-red-300 focus:border-red-500"
                                        : "border-gray-200 focus:border-blue-500"
                                    } focus:outline-none focus:ring-2 focus:ring-blue-500/20`}
                    ...
                    <button
                        type="submit"
                        className={`w-full h-12 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 flex items-center justify-center transition-colors ${loading || passwordTooShort || passwordMismatch
