...
export default function AttachmentPreviewModal({
    ...
    const isImage = (url) => {
        return /\.(jpg|jpeg|png|webp|avif|gif)$/i.test(url) || attachment.attachmentType === 'image';
    };
    ...
    const renderPreview = () => {
        ...
        return (
            <div className="flex flex-col items-center justify-center py-16 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
                ...
                <p className="text-gray-500 mb-6 font-medium">Preview not available for this file type</p>
                <button
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden modal-content-enter">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-white sticky top-0 z-10">
                    <div className="flex flex-col">
                        ...
                        <p className="text-xs text-gray-500 font-medium">Attachment Preview</p>
                    </div>
